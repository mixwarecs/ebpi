            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 14,
                  backgroundImage: [
                    "repeating-linear-gradient(90deg, rgba(180,90,30,0.72) 0px, rgba(180,90,30,0.72) 7px, transparent 7px, transparent 13px)",
                    "repeating-linear-gradient(90deg, rgba(180,90,30,0.72) 0px, rgba(180,90,30,0.72) 7px, transparent 7px, transparent 13px)",
                    "repeating-linear-gradient(0deg,  rgba(180,90,30,0.72) 0px, rgba(180,90,30,0.72) 7px, transparent 7px, transparent 13px)",
                    "repeating-linear-gradient(0deg,  rgba(180,90,30,0.72) 0px, rgba(180,90,30,0.72) 7px, transparent 7px, transparent 13px)",
                  ].join(","),
