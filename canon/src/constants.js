...
export const GS = {
  ...
  overlay: (open) => ({ position: "fixed", inset: 0, background: "rgba(10,6,1,0.75)", backdropFilter: "blur(6px)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center", opacity: open ? 1 : 0, pointerEvents: open ? "all" : "none", transition: "opacity 0.25s" }),
  popupCard: { background: "linear-gradient(160deg,#1e0f05,#0f0702)", border: `1px solid rgba(201,168,76,0.35)`, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 680, maxHeight: "88dvh", overflowY: "auto", overscrollBehavior: "contain", position: "relative", boxShadow: "0 -8px 40px rgba(0,0,0,0.7)", textAlign: "left", animation: "sheetUp 0.32s cubic-bezier(0.22,1,0.36,1) both" },
