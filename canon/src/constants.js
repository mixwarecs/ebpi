...
export const GS = {
  ...
  overlay: (open) => ({ position: "fixed", inset: 0, background: "rgba(10,6,1,0.88)", backdropFilter: "blur(8px)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, opacity: open ? 1 : 0, pointerEvents: open ? "all" : "none", transition: "opacity 0.25s" }),
  popupCard: { background: "linear-gradient(145deg,#1a0d04,#0f0702)", border: `1px solid rgba(201,168,76,0.4)`, borderRadius: 16, maxWidth: 640, width: "100%", maxHeight: "90vh", overflowY: "auto", position: "relative", boxShadow: "0 20px 60px rgba(0,0,0,0.7)", textAlign: "left" },
