...
// ── SHELF STYLES (S) ──────────────────────────────────────────────────────────
export const S = {
  outer: { fontFamily: "'Georgia', serif", backgroundColor: "#2C1A0E", backgroundImage: "url('/textures/leather-fine.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", color: PARCHMENT, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", padding: "28px 16px 48px" },
  ...
  tabRail: (side) => ({
    ...
    backgroundImage: "linear-gradient(180deg, rgba(12,6,2,0.52), rgba(10,5,2,0.60)), url('/textures/leather-fine.jpg')", backgroundSize: "cover", backgroundPosition: "center",
  ...
  stepTab: (color, active, height) => ({
    ...
    background: active ? `${color}CC` : `${color}77`,
    border: `1px solid ${color}${active ? "99" : "50"}`,
    borderRadius: "6px",
    boxShadow: active ? `0 2px 10px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.12)` : `0 1px 4px rgba(0,0,0,0.30)`,
  ...
  page: { flex: 1, minWidth: 0, overflowY: "auto", padding: "36px 30px 60px", backgroundImage: "linear-gradient(rgba(18,10,3,0.68), rgba(12,7,2,0.72)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center" },
  fullPage: { flex: 1, minWidth: 0, overflowY: "auto", padding: "40px 56px 70px", backgroundImage: "linear-gradient(rgba(18,10,3,0.68), rgba(12,7,2,0.72)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center" },
  ...
  classCard: (color) => ({
    background: "rgba(22,13,4,0.48)", borderTop: `3px solid ${color}`, borderRight: `1px solid ${color}38`, borderBottom: `1px solid ${color}38`, borderLeft: `1px solid ${color}38`,
  ...
  backLink: { fontSize: 12, letterSpacing: 2, color: PARCHMENT, cursor: "pointer", marginBottom: 22, display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(201,168,76,0.14)", border: "1px solid rgba(201,168,76,0.35)", borderRadius: 20, padding: "6px 16px 6px 12px", textShadow: "0 1px 4px rgba(0,0,0,0.7)" },
  divEyebrow: (color) => ({ fontSize: 10, letterSpacing: 5, color, textTransform: "uppercase", marginBottom: 12, display: "flex", alignItems: "center", gap: 10, textShadow: `0 0 16px ${color}, 0 0 8px ${color}99, 0 1px 6px rgba(0,0,0,0.95)` }),
  divH1: { fontFamily: "'Georgia',serif", fontSize: "clamp(32px,4.5vw,50px)", fontWeight: 900, color: PARCHMENT, letterSpacing: -0.5, lineHeight: 1, marginBottom: 10, textShadow: "0 2px 10px rgba(0,0,0,0.7)" },
  divRange: { fontSize: 13, color: "rgba(242,232,208,0.85)", letterSpacing: 1.5, marginBottom: 16, textShadow: "0 1px 5px rgba(0,0,0,0.8)" },
  divTagline: { fontStyle: "italic", fontSize: 17, color: "rgba(242,232,208,0.95)", lineHeight: 1.6, maxWidth: 680, marginBottom: 30, textShadow: "0 1px 5px rgba(0,0,0,0.7)" },
  sectionLabel: (color) => ({ fontSize: 10, letterSpacing: 3.5, color: "rgba(201,168,76,0.75)", textTransform: "uppercase", marginBottom: 14, paddingBottom: 8, borderBottom: `1px solid ${color}35`, textShadow: "0 1px 4px rgba(0,0,0,0.8)" }),
  prose: { fontSize: 15.5, lineHeight: 1.8, color: "rgba(242,232,208,0.88)", marginBottom: 30 },
  bookGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px,1fr))", gap: 13, marginBottom: 8 },
  bookCard: (color) => ({
    background: "rgba(22,13,4,0.45)", borderTop: `1px solid ${color}30`, borderRight: `1px solid ${color}30`, borderBottom: `1px solid ${color}30`, borderLeft: `3px solid ${color}`,
  ...
  callout: { background: "rgba(22,13,4,0.46)", border: `1px solid rgba(201,168,76,0.2)`, borderRadius: 3, padding: "16px 18px" },
  ...
  sienna: { background: "linear-gradient(90deg, rgba(201,168,76,0.10), rgba(201,168,76,0.02))", borderLeft: `3px solid rgba(201,168,76,0.55)`, padding: "15px 18px", borderRadius: "0 3px 3px 0", marginBottom: 30 },
  siennaLabel: { fontSize: 9, letterSpacing: 3, color: "rgba(201,168,76,0.88)", marginBottom: 8, textTransform: "uppercase", fontWeight: 700, textShadow: "0 1px 4px rgba(0,0,0,0.7)" },
  siennaText: { fontSize: 14, lineHeight: 1.75, color: "rgba(242,232,208,0.85)", fontStyle: "italic" },
  verseBox: { background: "linear-gradient(135deg,rgba(22,13,4,0.65),rgba(15,9,2,0.78))", border: `1px solid rgba(201,168,76,0.25)`, borderRadius: 3, padding: "18px 22px", marginBottom: 32, textAlign: "center" },
...
export const GS = {
  app: { fontFamily: "'Georgia', serif", backgroundImage: "linear-gradient(rgba(18,10,3,0.50), rgba(12,7,2,0.52)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "local", color: PARCHMENT, minHeight: "100vh", overflowX: "hidden" },
  topBar: { height: 3, background: `linear-gradient(90deg, transparent, ${GOLD}, ${SIENNA}, ${GOLD}, transparent)` },
  header: { textAlign: "center", padding: "48px 20px 32px", borderBottom: `1px solid rgba(201,168,76,0.3)`, backgroundImage: "linear-gradient(180deg, rgba(18,10,3,0.68), rgba(22,13,4,0.44)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center top" },
  eyebrow: { fontFamily: "'Georgia',serif", fontSize: 10, letterSpacing: 6, color: GOLD, textTransform: "uppercase", marginBottom: 14, opacity: 1 },
  ...
  subline: { fontStyle: "italic", fontSize: 17, color: "rgba(242,232,208,0.92)", maxWidth: 480, margin: "0 auto 20px", lineHeight: 1.6, textShadow: "0 1px 4px rgba(0,0,0,0.5)" },
  ...
  eraLegend: { display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap", padding: "12px 20px", background: "rgba(12,7,2,0.55)", borderBottom: `1px solid rgba(201,168,76,0.25)` },
  eraDot: { display: "flex", alignItems: "center", gap: 8, fontSize: 11, color: "rgba(242,232,208,0.92)" },
  infoPanel: { backgroundImage: "linear-gradient(180deg, rgba(18,10,3,0.80), rgba(12,7,2,0.84)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center", borderBottom: `1px solid rgba(201,168,76,0.2)` },
  ...
  tabNavFade: { position: "absolute", right: 0, top: 0, bottom: 1, width: 80, background: `linear-gradient(90deg, transparent, rgba(12,7,2,0.95))`, pointerEvents: "none", display: "flex", alignItems: "center", justifyContent: "flex-end", paddingRight: 10 },
  tabBtn: (active) => ({
  ...
  metaLabel: { fontSize: 9, letterSpacing: 3, color: "rgba(201,168,76,0.85)", marginBottom: 5, textTransform: "uppercase" },
  metaValue: { fontSize: 15, color: PARCHMENT, lineHeight: 1.4, textShadow: "0 1px 4px rgba(0,0,0,0.6)" },
  divider: { height: 1, background: "linear-gradient(90deg,rgba(201,168,76,0.2),transparent)", margin: "18px 0" },
  prose: { fontSize: 16, lineHeight: 1.78, color: "rgba(242,232,208,0.96)", maxWidth: 1080, textShadow: "0 1px 3px rgba(0,0,0,0.55)" },
  theoGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 16, marginBottom: 20 },
  theoCard: { background: "rgba(22,13,4,0.48)", border: `1px solid rgba(201,168,76,0.18)`, borderRadius: 3, padding: 18 },
  ...
  audienceBox: { marginTop: 22, background: "linear-gradient(90deg,rgba(201,168,76,0.10),rgba(201,168,76,0.03))", borderLeft: `3px solid rgba(201,168,76,0.50)`, padding: "14px 18px", borderRadius: "0 3px 3px 0" },
  ...
  christBox: { background: "linear-gradient(135deg,rgba(22,13,4,0.65),rgba(15,9,2,0.78))", border: `1px solid rgba(201,168,76,0.2)`, borderRadius: 3, padding: "18px 22px", marginBottom: 18 },
  ...
  sourceCard: { background: "rgba(22,13,4,0.42)", border: `1px solid rgba(201,168,76,0.18)`, borderRadius: 3, padding: "14px 16px" },
  sourceTier: { fontSize: 8, letterSpacing: 3, color: GOLD, marginBottom: 4 },
  sourceTitle: { fontSize: 15, fontWeight: 600, color: PARCHMENT, lineHeight: 1.3, marginBottom: 2, textShadow: "0 1px 3px rgba(0,0,0,0.5)" },
  sourceAuthor: { fontStyle: "italic", fontSize: 13, color: "rgba(242,232,208,0.88)", marginBottom: 2 },
  sourceMeta: { fontSize: 9, letterSpacing: 2, color: "rgba(201,168,76,0.75)" },
  timelineWrap: { overflowX: "auto", padding: "52px 40px 100px", cursor: "grab", position: "relative", backgroundImage: "linear-gradient(rgba(18,10,3,0.62), rgba(12,7,2,0.64)), url('/textures/parchment-warm.jpg')", backgroundSize: "cover", backgroundPosition: "center" },
  ...
  overlay: (open) => ({ position: "fixed", inset: 0, background: "rgba(10,6,1,0.82)", backdropFilter: "blur(6px)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "max(16px, env(safe-area-inset-top,16px)) 16px max(16px, env(safe-area-inset-bottom,16px))", opacity: open ? 1 : 0, pointerEvents: open ? "all" : "none", transition: "opacity 0.25s" }),
  popupCard: { background: "linear-gradient(160deg,#1e0f05,#0f0702)", border: `1px solid rgba(201,168,76,0.35)`, borderRadius: 16, width: "100%", maxWidth: 680, maxHeight: "82dvh", overflowY: "auto", overscrollBehavior: "contain", position: "relative", boxShadow: "0 8px 48px rgba(0,0,0,0.8)", textAlign: "left", animation: "sheetUp 0.32s cubic-bezier(0.22,1,0.36,1) both" },
  popupHeader: { padding: "28px 28px 20px", borderBottom: `1px solid rgba(201,168,76,0.2)`, display: "flex", gap: 20, alignItems: "flex-start" },
  popupAvatar: (color) => ({ width: 96, height: 96, borderRadius: 12, border: `1px solid ${color}`, background: `linear-gradient(135deg,rgba(22,13,4,0.9),rgba(201,168,76,0.1))`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, fontWeight: 700, color, flexShrink: 0 }),
  ...
  typeBanner: { background: "linear-gradient(90deg,rgba(201,168,76,0.12),rgba(201,168,76,0.03))", borderLeft: `3px solid rgba(201,168,76,0.50)`, padding: "11px 14px", borderRadius: "0 3px 3px 0", marginTop: 8 },
  ntBox: { background: "rgba(22,13,4,0.52)", border: `1px solid rgba(201,168,76,0.18)`, borderRadius: 3, padding: "11px 14px", marginTop: 8, fontSize: 14, lineHeight: 1.65, color: "rgba(242,232,208,0.88)" },
  closeBtn: { position: "absolute", top: 14, right: 14, width: 30, height: 30, background: "rgba(201,168,76,0.1)", border: `1px solid rgba(201,168,76,0.3)`, borderRadius: "50%", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: GOLD, fontSize: 15, zIndex: 10 },
  ...
  chTooltip: { position: "fixed", background: "rgba(15,9,2,0.97)", border: `1px solid rgba(201,168,76,0.3)`, borderRadius: 14, padding: "16px 18px", maxWidth: 280, pointerEvents: "none", zIndex: 500, boxShadow: "0 8px 30px rgba(0,0,0,0.6)", textAlign: "left" },
