...
export const UI = {
  es: {
    ...
    summariesHint: "Clic en el número de capítulo → leer pasaje en BibleGateway · Reproduce el audio de cada capítulo abajo ↓",
    timelineLabel: "LÍNEA DE PERSONAJES",
    summariesLabel: "RESÚMENES DE CAPÍTULOS",
  ...
  en: {
    ...
    summariesHint: "Click a chapter number → read the passage on BibleGateway · Play chapter audio below ↓",
    timelineLabel: "CHARACTER TIMELINE",
    summariesLabel: "CHAPTER SUMMARIES",
  ...
  pt: {
    ...
    summariesHint: "Clique no número do capítulo → ler passagem no BibleGateway · Reproduza o áudio de cada capítulo abaixo ↓",
    timelineLabel: "LINHA DE PERSONAGENS",
    summariesLabel: "RESUMOS DOS CAPÍTULOS",
    pipeline: "CANON PIPELINE v1.2.0 · PROTESTANTISMO REFORMADO · NBLA / ESV / ARC",
