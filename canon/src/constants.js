...
export const GS = {
  ...
  tabNav: { display: "flex", borderBottom: `1px solid rgba(201,168,76,0.15)`, overflowX: "auto", padding: "0 0", gap: 0, scrollbarWidth: "none", msOverflowStyle: "none", background: "rgba(201,168,76,0.07)", borderTop: `1px solid rgba(139,90,20,0.12)` },
  ...
  tabBtn: (active) => ({
    ...
    border: "none", borderBottom: active ? `2px solid rgba(139,90,20,0.85)` : "2px solid transparent",
