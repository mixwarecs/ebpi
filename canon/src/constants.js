...
export const GS = {
  app: { fontFamily: "'Georgia', serif", backgroundImage: "linear-gradient(rgba(18,10,3,0.38), rgba(12,7,2,0.40)), url('/textures/pergament.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "local", color: PARCHMENT, minHeight: "100vh", overflowX: "hidden" },
  topBar: { height: 3, background: `linear-gradient(90deg, transparent, ${GOLD}, ${SIENNA}, ${GOLD}, transparent)` },
  header: { textAlign: "center", padding: "48px 20px 32px", borderBottom: `1px solid rgba(201,168,76,0.3)`, backgroundImage: "linear-gradient(180deg, rgba(18,10,3,0.32), rgba(22,13,4,0.28)), url('/textures/pergament.jpg')", backgroundSize: "cover", backgroundPosition: "center top" },
  ...
  infoPanel: { backgroundImage: "linear-gradient(180deg, rgba(18,10,3,0.38), rgba(12,7,2,0.40)), url('/textures/pergament.jpg')", backgroundSize: "cover", backgroundPosition: "center", borderBottom: `1px solid rgba(201,168,76,0.2)` },
  ...
  tabNavFade: { position: "absolute", right: 0, top: 0, bottom: 1, width: 80, background: `linear-gradient(90deg, transparent, rgba(220,195,155,0.95))`, pointerEvents: "none", display: "flex", alignItems: "center", justifyContent: "flex-end", paddingRight: 10 },
  tabBtn: (active) => ({
    fontFamily: "'Georgia',serif", fontSize: 14, fontWeight: 600, letterSpacing: 1.5,
    color: active ? "rgba(80,45,10,1)" : "rgba(65,38,8,0.60)",
    background: "none", borderTop: "none", borderRight: "none", borderLeft: "none",
    borderBottom: active ? `2px solid rgba(139,90,20,0.85)` : "2px solid transparent",
  ...
  timelineWrap: { overflowX: "auto", padding: "52px 40px 100px", cursor: "grab", position: "relative", backgroundImage: "linear-gradient(rgba(18,10,3,0.48), rgba(12,7,2,0.50)), url('/textures/pergament.jpg')", backgroundSize: "cover", backgroundPosition: "center" },
