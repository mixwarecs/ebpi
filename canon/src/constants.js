...
export const UI = {
  es: {
    ...
    summariesHint: "Clic en el número → leer pasaje · Reproduce el audio · Al terminar avanza automáticamente al siguiente capítulo ↓",
  ...
  en: {
    ...
    summariesHint: "Click number → read passage · Play chapter audio · Automatically advances to the next chapter when done ↓",
  ...
  pt: {
    ...
    summariesHint: "Clique no número → ler passagem · Reproduza o áudio · Avança automaticamente para o próximo capítulo ao terminar ↓",
