...
export const S = {
  ...
  gutterShadowLeft: { position: "absolute", left: "50%", top: 0, bottom: 0, width: 36, marginLeft: -36, background: "linear-gradient(90deg, transparent, rgba(0,0,0,0.30))", pointerEvents: "none", zIndex: 5 },
  gutterShadowRight: { position: "absolute", left: "50%", top: 0, bottom: 0, width: 36, background: "linear-gradient(90deg, rgba(0,0,0,0.30), transparent)", pointerEvents: "none", zIndex: 5 },
