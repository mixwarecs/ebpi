...
export function balancedContiguousSplit(items, heights, cols) {
...
export function chapterColor(ch, chapterEras) {
  const era = chapterEras.find(e => ch >= e.from && ch <= e.to);
  return era ? era.color : "#C9A84C";
}
